      ...
      <div v-if="account.type === 'apikey'" class="space-y-4">
        ...
        <div v-if="account.platform === 'seedance'" class="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          <div>
            ...
            <input v-model.number="editVideoPollTimeoutMs" type="number" min="1000" step="1000" class="input" />
          </div>
          <div>
            <label class="input-label">{{ t('admin.accounts.video.requestTimeoutMs') }}</label>
            <input v-model.number="editVideoRequestTimeoutMs" type="number" min="1000" step="1000" class="input" />
          </div>
          <div>

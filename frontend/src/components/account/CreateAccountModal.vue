    ...
    >
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        <div v-if="form.platform === 'seedance'" class="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          <div>
            <label class="input-label">{{ t('admin.accounts.video.pollTimeoutMs') }}</label>
            <input v-model.number="videoPollTimeoutMs" type="number" min="1000" step="1000" class="input" />
          </div>
          <div>
            <label class="input-label">{{ t('admin.accounts.video.requestTimeoutMs') }}</label>
            <input v-model.number="videoRequestTimeoutMs" type="number" min="1000" step="1000" class="input" />
          </div>
          <div>
            <label class="input-label">{{ t('admin.accounts.video.connectTimeoutMs') }}</label>
            <input v-model.number="videoConnectTimeoutMs" type="number" min="1000" step="1000" class="input" />
          </div>
        </div>
        <div>
...
const resetForm = () => {
  ...
  videoRequestTimeoutMs.value = 60000
  videoConnectTimeoutMs.value = 15000

export default {
    ...
    channels: {
      ...
      form: {
        ...
        videoResolutionPrices: '视频分辨率价格',
        videoDisplayPricingHint: '这里配置的是模型广场展示价，不参与视频任务实际扣费；实际扣费继续以分组中的视频计费规则为准。',
        videoResolutionPriceRequired: '视频按秒模式至少需要配置一个分辨率价格',
        noVideoResolutionPrices: '暂无分辨率价格，点击添加后填写每秒展示价',
        addResolution: '添加分辨率',
        perSecondPrice: '每秒价格',
        second: '秒',
        platformConfig: '平台配置',

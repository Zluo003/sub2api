export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      video: {
        seedanceAdapter: 'Aigod Seedance Video',
        baseUrlHint: 'Default: https://api.aigod.one. Visible to admins only.',
        apiKeyHint: 'Upstream Aigod API key, stored only in the local account credentials',
        apiPath: 'API Path',
        apiPathHint: 'Default: /v1/videos',

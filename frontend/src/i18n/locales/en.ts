  ...
  admin: {
    ...
    groups: {
      ...
      agent: {
        ...
        protected: 'Protected',
        protectedHint: 'The installation and authorization flow maintains this system Agent group, so it cannot be deleted.',
      ...
      agentPricing: {
        title: 'Model pricing',
        subtitle: 'Base prices and model multipliers are stored separately; user or group multipliers remain the outer adjustment. New rules start disabled.',
        completeDefaults: 'Complete defaults',
        addRule: 'Add pricing rule',
        image: 'Image',
        video: 'Video',
        text: 'Text',
        empty: 'No pricing rules for this media type',
        model: 'Model ID',
        platform: 'Platform',
        resolution: 'Resolution',
        perImage: 'Base price / image',
        perSecond: 'Base price / second',
        multiplier: 'Model multiplier',
        effectivePrice: 'Effective model unit price',
        referenceMultiplier: 'Reference video multiplier',
        inputPerMillion: 'Input / 1M tokens',
        outputPerMillion: 'Output / 1M tokens',
        cacheWritePerMillion: 'Cache write / 1M tokens',
        cacheReadPerMillion: 'Cache read / 1M tokens',
        enabled: 'Enabled',
        loadFailed: 'Failed to load Agent model pricing',
      },
      columns: {
        name: 'Name',
        platform: 'Platform',

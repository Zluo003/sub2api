  ...
  admin: {
    ...
    groups: {
      ...
      agent: {
        ...
        systemCode: '系统代码',
        multiPlatform: '多平台路由',
        systemExclusive: '系统专属',
        protected: '系统保护',
        protectedHint: '系统 Agent 分组由安装与授权流程维护，不能删除',
      ...
      agentPricing: {
        title: '模型定价',
        subtitle: '基础价与模型倍率分别保存，最终结算仍叠加用户或分组倍率；新增规则默认停用',
        completeDefaults: '补全默认模型',
        addRule: '添加定价规则',
        image: '图片',
        video: '视频',
        text: '文本',
        ...
        perSecond: '每秒基础价',
        multiplier: '模型倍率',
        effectivePrice: '模型结算单价',
        referenceMultiplier: '参考视频倍率',
        inputPerMillion: '输入 / 百万 token',
        outputPerMillion: '输出 / 百万 token',
        cacheWritePerMillion: '缓存写入 / 百万 token',
        cacheReadPerMillion: '缓存读取 / 百万 token',
        enabled: '启用',
        loadFailed: '加载 Agent 模型定价失败',
      },

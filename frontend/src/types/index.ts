...
export interface Group {
  ...
  video_pricing_rules?: VideoGroupPricingRule[]
  created_at: string
  updated_at: string
}
...
export type UsageRequestType = 'unknown' | 'sync' | 'stream' | 'ws_v2' | 'cyber' | 'video'
...
export interface UsageLog {
  ...
  video_reference_duration_seconds?: number
  video_billable_seconds?: number

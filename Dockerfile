...
ARG GOLANG_IMAGE=golang:1.26.8-alpine
...
# Install pnpm (pinned to match the lockfile/config generated by local tooling)
RUN corepack enable && corepack prepare pnpm@10.23.0 --activate

# Install dependencies first (better caching)
# pnpm-workspace.yaml 是本仓库固定 pnpm 10 后需要的配置，必须一并拷入
...
# Labels
LABEL maintainer="Zluo003 <github.com/Zluo003>"
LABEL description="Sub2API - AI API Gateway Platform"
LABEL org.opencontainers.image.source="https://github.com/Zluo003/sub2api"

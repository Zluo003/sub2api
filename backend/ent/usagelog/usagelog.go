...
const (
	...
	// FieldVideoTaskID holds the string denoting the video_task_id field in the database.
	FieldVideoTaskID = "video_task_id"
	...
	// FieldVideoReferenceDurationSeconds holds the string denoting the video_reference_duration_seconds field in the database.
	FieldVideoReferenceDurationSeconds = "video_reference_duration_seconds"
	// FieldVideoBillableSeconds holds the string denoting the video_billable_seconds field in the database.
...
var (
	...
	// VideoTaskIDValidator is a validator for the "video_task_id" field. It is called by the builders before save.
	VideoTaskIDValidator func(string) error
	...
	// DefaultVideoReferenceDurationSeconds holds the default value on creation for the "video_reference_duration_seconds" field.
...
// ByVideoTaskID orders the results by the video_task_id field.
func ByVideoTaskID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldVideoTaskID, opts...).ToFunc()
}
...
// ByVideoReferenceDurationSeconds orders the results by the video_reference_duration_seconds field.
func ByVideoReferenceDurationSeconds(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldVideoReferenceDurationSeconds, opts...).ToFunc()
}

// ByVideoBillableSeconds orders the results by the video_billable_seconds field.
func ByVideoBillableSeconds(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldVideoBillableSeconds, opts...).ToFunc()
}

...
// was not loaded in eager-loading.
func (e AccountEdges) VideoTasksOrErr() ([]*VideoTask, error) {
	if e.loadedTypes[3] {
...
// QueryVideoTasks queries the "video_tasks" edge of the Account entity.
func (_m *Account) QueryVideoTasks() *VideoTaskQuery {
	return NewAccountClient(_m.config).QueryVideoTasks(_m)
}

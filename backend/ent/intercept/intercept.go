...
// The VideoGroupPricingRuleFunc type is an adapter to allow the use of ordinary function as a Querier.
type VideoGroupPricingRuleFunc func(context.Context, *ent.VideoGroupPricingRuleQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f VideoGroupPricingRuleFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.VideoGroupPricingRuleQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.VideoGroupPricingRuleQuery", q)
}

// The TraverseVideoGroupPricingRule type is an adapter to allow the use of ordinary function as Traverser.
type TraverseVideoGroupPricingRule func(context.Context, *ent.VideoGroupPricingRuleQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseVideoGroupPricingRule) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseVideoGroupPricingRule) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.VideoGroupPricingRuleQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.VideoGroupPricingRuleQuery", q)
}

// The VideoTaskFunc type is an adapter to allow the use of ordinary function as a Querier.
type VideoTaskFunc func(context.Context, *ent.VideoTaskQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f VideoTaskFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.VideoTaskQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.VideoTaskQuery", q)
}

// The TraverseVideoTask type is an adapter to allow the use of ordinary function as Traverser.
type TraverseVideoTask func(context.Context, *ent.VideoTaskQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseVideoTask) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseVideoTask) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.VideoTaskQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.VideoTaskQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.VideoGroupPricingRuleQuery:
		return &query[*ent.VideoGroupPricingRuleQuery, predicate.VideoGroupPricingRule, videogrouppricingrule.OrderOption]{typ: ent.TypeVideoGroupPricingRule, tq: q}, nil
	case *ent.VideoTaskQuery:
		return &query[*ent.VideoTaskQuery, predicate.VideoTask, videotask.OrderOption]{typ: ent.TypeVideoTask, tq: q}, nil
	default:

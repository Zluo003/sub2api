...
type Group struct {
	...
	// VideoModelPrices holds the value of the "video_model_prices" field.
	VideoModelPrices map[string]map[string]float64 `json:"video_model_prices,omitempty"`
	// SearchPricePer1k holds the value of the "search_price_per_1k" field.
	SearchPricePer1k *float64 `json:"search_price_per_1k,omitempty"`
	// AudioRealtimePricePerMin holds the value of the "audio_realtime_price_per_min" field.
	AudioRealtimePricePerMin *float64 `json:"audio_realtime_price_per_min,omitempty"`
	// AudioTtsPricePerMillionChars holds the value of the "audio_tts_price_per_million_chars" field.
	AudioTtsPricePerMillionChars *float64 `json:"audio_tts_price_per_million_chars,omitempty"`
	// AudioSttPricePerHour holds the value of the "audio_stt_price_per_hour" field.
	AudioSttPricePerHour *float64 `json:"audio_stt_price_per_hour,omitempty"`
	// LongContextPricingEnabled holds the value of the "long_context_pricing_enabled" field.
	LongContextPricingEnabled bool `json:"long_context_pricing_enabled,omitempty"`
	// ModelPricing holds the value of the "model_pricing" field.
	...
	// ForceOpenaiFast holds the value of the "force_openai_fast" field.
	ForceOpenaiFast bool `json:"force_openai_fast,omitempty"`
	// FreeOpenaiFast holds the value of the "free_openai_fast" field.
	...
	// CodexModelsManifestConfig holds the value of the "codex_models_manifest_config" field.
	...
	// MaxReasoningEffortOverLimit holds the value of the "max_reasoning_effort_over_limit" field.
...
type GroupEdges struct {
	...
	VideoPricingRules []*VideoGroupPricingRule `json:"video_pricing_rules,omitempty"`
...
// was not loaded in eager-loading.
func (e GroupEdges) VideoTasksOrErr() ([]*VideoTask, error) {
	if e.loadedTypes[4] {
...
// was not loaded in eager-loading.
func (e GroupEdges) VideoPricingRulesOrErr() ([]*VideoGroupPricingRule, error) {
	if e.loadedTypes[5] {
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldVideoModelPrices, group.FieldModelPricing, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelAllowlist, group.FieldCodexModelsManifestConfig, group.FieldModelsListConfig, group.FieldReasoningEffortMappings:
			values[i] = new([]byte)
		...
		case group.FieldRateMultiplier, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldSearchPricePer1k, group.FieldAudioRealtimePricePerMin, group.FieldAudioTtsPricePerMillionChars, group.FieldAudioSttPricePerHour, group.FieldWebSearchPricePerCall, group.FieldProfitMinMargin, group.FieldProfitSafetyBuffer:
			values[i] = new(sql.NullFloat64)
		case group.FieldID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldKind, group.FieldSystemCode, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldSystemCode:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field system_code", values[i])
			} else if value.Valid {
				_m.SystemCode = new(string)
				*_m.SystemCode = value.String
			}
...
// QueryVideoTasks queries the "video_tasks" edge of the Group entity.
func (_m *Group) QueryVideoTasks() *VideoTaskQuery {
	return NewGroupClient(_m.config).QueryVideoTasks(_m)
}

// QueryVideoPricingRules queries the "video_pricing_rules" edge of the Group entity.
func (_m *Group) QueryVideoPricingRules() *VideoGroupPricingRuleQuery {

...
func init() {
	...
	usagelogDescVideoTaskID := usagelogFields[40].Descriptor()
	...
	usagelogDescVideoDurationSeconds := usagelogFields[42].Descriptor()
	...
	usagelogDescVideoReferenceDurationSeconds := usagelogFields[43].Descriptor()
	...
	usagelogDescVideoBillableSeconds := usagelogFields[44].Descriptor()

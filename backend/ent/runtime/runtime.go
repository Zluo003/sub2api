...
func init() {
	...
	groupDescKind := groupFields[6].Descriptor()
	...
	groupDescSystemCode := groupFields[7].Descriptor()
	...
	usagelogDescVideoTaskID := usagelogFields[39].Descriptor()
	...
	usagelogDescVideoDurationSeconds := usagelogFields[41].Descriptor()
	...
	usagelogDescVideoReferenceDurationSeconds := usagelogFields[42].Descriptor()
	...
	usagelogDescVideoBillableSeconds := usagelogFields[43].Descriptor()

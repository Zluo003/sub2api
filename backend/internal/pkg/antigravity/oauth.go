...
func getClientSecret() (string, error) {
	...
	return "", infraerrors.New(http.StatusBadRequest, "ANTIGRAVITY_OAUTH_CLIENT_SECRET_MISSING", "missing antigravity oauth client_secret")
}
...
func getClientID() (string, error) {
	...
	return "", infraerrors.New(http.StatusBadRequest, "ANTIGRAVITY_OAUTH_CLIENT_ID_MISSING", "missing antigravity oauth client_id")
}

...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	...
	log.VideoDurationSeconds = videoDurationSeconds
	log.VideoReferenceDurationSeconds = videoReferenceSeconds
	log.VideoBillableSeconds = videoBillableSeconds

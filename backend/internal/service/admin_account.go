...
func (s *adminServiceImpl) BulkUpdateAccounts(ctx context.Context, input *BulkUpdateAccountsInput) (*BulkUpdateAccountsResult, error) {
	...
	if len(input.Credentials) > 0 || input.ProxyID != nil || needAccountPlatforms || hasLongContextBillingUpdate || input.ProbeEnabled != nil || input.RateMultiplier != nil {
...
// validateAgentAccountGroupBindings 阻止把不受支持的平台账号绑到系统 Agent 分组上。
// 原本在 admin_service.go，随上游拆分迁移到本文件。
...
// hasAgentGroup 报告 groupIDs 中是否包含系统 Agent 分组。

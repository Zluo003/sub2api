...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	agentHandler := handler.NewAgentHandler(db, configConfig, fileStorageService, billingService, videoService, channelService, userGroupRateRepository, apiKeyAuthCacheInvalidator, settingRepository, redisClient)

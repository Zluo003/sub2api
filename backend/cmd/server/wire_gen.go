...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	videoService := service.NewVideoService(videoAccountRepository, videoTaskRepository, videoGroupPricingRuleRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, apiKeyService, billingCacheService, deferredService, balanceNotifyService, serviceUserPlatformQuotaRepository, httpUpstream, configConfig)
	...
	yingzoDownloadTicketStore := repository.NewYingzoDownloadTicketStore(redisClient)
	agentHandler := handler.NewAgentHandler(db, configConfig, fileStorageService, billingService, videoService, channelService, userGroupRateRepository, apiKeyAuthCacheInvalidator, settingRepository, yingzoDownloadTicketStore)
